...
pub fn default_colors(t: ThemeType) -> ThemeColors {
    match t {
        ...
        ThemeType::Noctalia => ThemeColors {
            // Surface: deep navy indigo
            bg: [0.027, 0.027, 0.133, 1.0],
            surface: [0.067, 0.067, 0.176, 1.0],
            surface2: [0.102, 0.102, 0.239, 1.0],
            border: [0.129, 0.129, 0.373, 1.0],
            // Primary accent: warm yellow (was blue)
            accent: [1.0, 0.961, 0.608, 1.0],
            // Secondary accent: lavender
            accent2: [0.663, 0.682, 0.996, 1.0],
            text: [0.953, 0.929, 0.969, 1.0],
            text_dim: [0.486, 0.502, 0.706, 1.0],
            green: [0.608, 0.996, 0.808, 1.0],
            red: [0.992, 0.275, 0.388, 1.0],
            yellow: [1.0, 0.961, 0.608, 1.0],
            orange: [0.992, 0.275, 0.388, 1.0],
            tag_bg: [0.067, 0.067, 0.176, 1.0],
        },
    }
}
